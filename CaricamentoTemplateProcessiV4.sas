...
* Caricamento Template Processi BPER;
libname temp xlsx "C:\Ratio\CatenaProcessi_CSTGEST_2022-06-22.xlsx";
libname temp xlsx "D:\r\BPER\2022-06\DaPostazioneBper\CatenaProcessi_CSTGEST_2022-06-22.xlsx";
libname ORCH odbc dsn="ORCH";

/*
* Caricamento Template Processi BPER;
libname temp xlsx "C:\Ratio\CatenaProcessi_CSTGEST_2022-06-22.xlsx";
libname ORCH ODBC datasrc=ifrs9_test user="uifrs9" password="{SAS002}3FE19032477001830855F68825CCC513117E2369" schema=DBO insertbuff=32767;
*libname config "/sas/CSTGEST/sascode/default/pgm/cstgest_cantiere2";
*/
